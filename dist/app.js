...
// ***********************************************
// TEMPLATE EXTRACTORS
var projectFormTemplateExtractor = new TemplateExtractor('project-form', 'app');
var projectListTemplateExtractor1 = new TemplateExtractor('project-list', 'app');
var projectListTemplateExtractor2 = new TemplateExtractor('project-list', 'app');
var projectForm = new ProjectForm(projectFormTemplateExtractor);
var activeProjects = new ActiveProjects(projectListTemplateExtractor1);
var completedProjects = new CompletedProjects(projectListTemplateExtractor2);
var projectManager = new ProjectManager(Project, ProjectTemplate);
projectManager.addSubscriber(activeProjects);
projectManager.addSubscriber(completedProjects);
var projectDragManager = new ProjectDragManager(projectManager);
